...
import { 
  Search, Star, MapPin, ArrowRight, CheckCircle2, HelpCircle,
  Wrench, Zap, Paintbrush, Hammer, HardHat, Sparkles 
} from "lucide-react";
...
const CATEGORIAS = [
  { id: 1, slug: "encanador", nome: "Encanador", icon: Wrench, color: "bg-blue-500" },
  { id: 2, slug: "eletricista", nome: "Eletricista", icon: Zap, color: "bg-yellow-500" },
  { id: 3, slug: "pintor", nome: "Pintor", icon: Paintbrush, color: "bg-pink-500" },
  { id: 4, slug: "marceneiro", nome: "Marceneiro", icon: Hammer, color: "bg-orange-500" },
  { id: 5, slug: "pedreiro", nome: "Pedreiro", icon: HardHat, color: "bg-slate-500" },
  { id: 6, slug: "faxina", nome: "Faxina", icon: Sparkles, color: "bg-purple-500" },
];
        ...
        <div className="container mx-auto px-4 h-16 flex justify-between items-center">
          ...
          <nav className="hidden md:flex gap-2">
            <Link to="/como-funciona">
              <Button variant="ghost" className="text-slate-600 hover:text-orange-600 hover:bg-orange-50">Como funciona</Button>
            </Link>
            <Link to="/suporte">
              <Button variant="ghost" className="text-slate-600 hover:text-orange-600 hover:bg-orange-50 gap-2">
                <HelpCircle size={16} /> Suporte
              </Button>
            </Link>
            <div className="w-px h-6 bg-slate-200 mx-2 my-auto" />
            <Link to="/sou-profissional">
              <Button variant="ghost" className="font-medium text-slate-900">Sou Profissional</Button>
            </Link>
            <Link to="/sou-cliente">
      ...
      <main className="flex-1 pt-16">
        ...
        <section className="relative pt-20 pb-32 overflow-hidden">
          ...
          <div className="container relative z-10 mx-auto px-4 text-center max-w-4xl">
            ...
            >
              <Badge variant="outline" className="mb-6 px-4 py-1.5 text-sm bg-white/50 backdrop-blur border-orange-200 text-orange-700 shadow-sm rounded-full">
            ...
            >
              <div className="relative flex-1 group">
                <Search className={`absolute left-4 top-3.5 h-5 w-5 transition-colors ${isSearchFocused ? 'text-orange-500' : 'text-slate-400'}`} />
                <Input
              ...
              <Button size="lg" className="h-12 px-8 rounded-xl font-semibold bg-orange-600 hover:bg-orange-700 text-white shadow-lg shadow-orange-600/20 transition-all hover:scale-105 active:scale-95">
                Buscar
              </Button>
            </motion.div>
            ...
            >
              <div className="flex items-center gap-2"><CheckCircle2 size={16} className="text-green-500"/> Profissionais Verificados</div>
              <div className="flex items-center gap-2"><CheckCircle2 size={16} className="text-green-500"/> Orçamento Grátis</div>
              <div className="flex items-center gap-2"><CheckCircle2 size={16} className="text-green-500"/> Pagamento Seguro</div>
            </motion.div>
          </div>
        </section>
        ...
        <section className="py-20 container mx-auto px-4">
          <div className="flex justify-between items-end mb-10">
            <div>
              <h3 className="text-3xl font-bold text-slate-900 tracking-tight">Categorias Populares</h3>
              <p className="text-slate-500 mt-2">Encontre exatamente o que sua casa precisa.</p>
            </div>
            <Button variant="link" className="text-orange-600 font-semibold hidden md:flex group">
              ...
              <motion.div key={cat.id} variants={itemVariants}>
                ...
                >
                  ...
                  <CardContent className="flex flex-col items-center justify-center p-6 gap-4 relative z-10">
                    <div className={`p-4 rounded-2xl transition-transform duration-300 group-hover:scale-110 ${cat.color} bg-opacity-10`}>
                      <cat.icon size={32} className="text-slate-700 group-hover:text-slate-900" />
                    </div>
        ...
        <section className="py-20 bg-slate-900 text-slate-50 rounded-t-[3rem] mt-8">
          <div className="container mx-auto px-4">
            <div className="flex justify-between items-end mb-12">
              <div>
                <Badge className="bg-orange-500 hover:bg-orange-600 text-white mb-3 border-0">Em alta na Semana</Badge>
              ...
              <Button variant="outline" className="border-slate-900 text-slate-300 hover:bg-slate-800 hover:text-white hidden md:flex">
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-start justify-between mb-6">
                        <div className="flex items-center gap-4">
                          <div className="relative">
                            <Avatar className="h-14 w-14 border-2 border-slate-700 group-hover:border-orange-500 transition-colors">
                              ...
                              <AvatarFallback className="bg-slate-700 text-white">{prof.nome[0]}</AvatarFallback>
                            </Avatar>
                            <div className="absolute -bottom-1 -right-1 bg-green-500 w-4 h-4 rounded-full border-2 border-slate-800" title="Online agora"></div>
                          </div>
                          <div>
                        ...
                        <div className="flex flex-col items-end">
                            ...
                            <Star size={14} className="fill-orange-500 text-orange-500 mr-1" />
                            {prof.rating}
                            </div>
                            <span className="text-xs text-slate-500 mt-1">120 jobs</span>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center justify-between text-sm text-slate-400">
                        <div className="flex items-center">
                          <MapPin size={14} className="mr-1 text-slate-500" /> São Paulo, SP
                        </div>
             ...
             <div className="bg-linear-to-r from-orange-600 to-red-500 rounded-3xl p-8 md:p-16 text-center md:text-left relative overflow-hidden shadow-2xl shadow-orange-900/20">
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                    <div className="max-w-xl text-white">
                        <h2 className="text-3xl md:text-5xl font-bold mb-6">Você é um profissional?</h2>
                        <p className="text-orange-50 text-lg mb-8">
                            Junte-se a mais de 10.000 especialistas que estão crescendo seus negócios com a ObraFácil. Planos iniciais que cabem no seu bolso, seu futuro começa aqui!
                        </p>
                        <div className="flex flex-col sm:flex-row gap-4">
                            {/* LINK CORRIGIDO PARA A ROTA DO PROFISSIONAL */}
                            <Link to="/sou-profissional"> 
                                <Button size="lg" className="bg-white text-orange-600 hover:bg-slate-100 font-bold border-0 h-14 px-8 text-lg">
                                    Começar Agora
                                </Button>
                            </Link>
        ...
        <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div>
                <div className="flex items-center gap-2 mb-4">
                    <div className="w-6 h-6 bg-orange-600 rounded-md flex items-center justify-center text-white text-xs font-bold">O</div>
                    <span className="font-bold text-slate-900">ObraFácil</span>
                </div>
                <p className="mb-4">Facilitando a conexão entre quem precisa e quem sabe fazer.</p>
            </div>
            <div>
                ...
                <ul className="space-y-2">
                    ...
                    <li><a href="#" className="hover:text-orange-600 transition-colors">Carreiras</a></li>
                    <li><a href="#" className="hover:text-orange-600 transition-colors">Imprensa</a></li>
                </ul>
            </div>
            <div>
                <h4 className="font-bold text-slate-900 mb-4">Descubra</h4>
                <ul className="space-y-2">
                    <li><a href="#" className="hover:text-orange-600 transition-colors">Como funciona</a></li>
                    <li><a href="#" className="hover:text-orange-600 transition-colors">Segurança</a></li>
                    <li><a href="#" className="hover:text-orange-600 transition-colors">Guia de preços</a></li>
                </ul>
            </div>
              <div>
